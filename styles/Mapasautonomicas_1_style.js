...
var style_Mapasautonomicas_1 = function(feature, resolution){
    ...
    var value = feature.get("2019_ABSPERCENT");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("2019_ABSPERCENT") !== null) {
        labelText = String(feature.get("2019_ABSPERCENT"));
    }
    if (value >= 0.000000 && value <= 26.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.000000 && value <= 43.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 43.000000 && value <= 95.000000) {
            style = [ new ol.style.Style({
